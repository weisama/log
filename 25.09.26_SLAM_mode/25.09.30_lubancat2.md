...
export ROS_IP=10.42.0.4							#自身广播IP，网线版
#export ROS_IP=10.28.190.210					#自身广播IP，wifi版
export ROS_LOCALHOST_ONLY=0						#允许多机通信
export RMW_IMPLEMENTATION=rmw_fastrtps_cpp		#通信方式
export ROS_DISCOVERY_SERVER="10.42.0.1:11811"	#要连接的服务器
```

本机 `~/.bashrc`：
```bash
export ROS_DOMAIN_ID=0							#需要ID相同
export ROS_IP=10.42.0.1							#自身广播IP，网线版
#export ROS_IP=10.28.185.149					#自身广播IP，wifi版
export ROS_LOCALHOST_ONLY=0						#允许多机通信
export RMW_IMPLEMENTATION=rmw_fastrtps_cpp		#通信方式
export ROS_DISCOVERY_SERVER="10.42.0.4:11811"	#要连接的服务器
```
