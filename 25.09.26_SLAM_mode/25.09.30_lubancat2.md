...
export ROS_IP=192.168.110.186
export ROS_LOCALHOST_ONLY=0
#export RMW_IMPLEMENTATION=rmw_fastrtps_cpp
#export ROS_DISCOVERY_SERVER="192.168.110.171:11811"
```

本机 `~/.bashrc`：
```bash
export ROS_DOMAIN_ID=0							#需要ID相同
export ROS_IP=192.168.110.186					#自身IP
export ROS_LOCALHOST_ONLY=0						允许多机通信
#export RMW_IMPLEMENTATION=rmw_fastrtps_cpp		#通信方式
#export ROS_DISCOVERY_SERVER="192.168.110.186:11811"	#要连接的服务器
```
