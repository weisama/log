...
## 通过网线网络共享窗口转发更快，或设置wifi为ros分布设通信
...
### sd卡系统内
ls etc/NetworkManager/system-connections
sudo nano etc/NetworkManager/system-connections/@CLM407.nmconnection
```

```bash
[connection]
id=@CLM407
uuid=cdf79605-5f7a-47de-801a-4e968036b98b
type=wifi
interface-name=wlan0
...
[ipv4]
address1=192.168.110.186/24,192.168.110.1
dns=192.168.110.1;
method=manual
...
```bash
# wifi连接
ssh -Y cat@10.28.190.210
ssh -Y cat@192.168.110.186
```
...
export ROS_IP=10.28.190.210
export ROS_LOCALHOST_ONLY=0
#export RMW_IMPLEMENTATION=rmw_fastrtps_cpp
#export ROS_DISCOVERY_SERVER="10.28.188.133:11811"
```
...
```bash
export ROS_DOMAIN_ID=0							#需要ID相同
export ROS_IP=10.28.188.133						#自身IP
export ROS_LOCALHOST_ONLY=0						#允许多机通信
#export RMW_IMPLEMENTATION=rmw_fastrtps_cpp		#通信方式
#export ROS_DISCOVERY_SERVER="10.28.190.21:11811"	#要连接的服务器
```
