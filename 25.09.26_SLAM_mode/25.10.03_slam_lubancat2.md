...
def generate_launch_description():
    ...
    sync_async = LaunchConfiguration('sync_async')
    ...
    declare_sync_async_cmd = DeclareLaunchArgument(
        'sync_async', default_value='async',
        description='Run SLAM in sync or async mode'
    )

    slam_params_file = os.path.join(
        get_package_share_directory("karto_slam"),
    ...
    slam_node = Node(
        ...
        executable=PythonExpression([
            "str(", sync_async, ") + '_slam_toolbox_node'"
        ]),
        name='slam_toolbox',
        output='screen',
        parameters=[
