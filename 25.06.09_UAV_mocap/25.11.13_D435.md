...
```
# 安装环境
sudo apt install git cmake libopencv-dev libeigen3-dev libboost-all-dev
sudo apt-get install libglew-dev libpython2.7-dev libwayland-dev libxkbcommon-dev wayland-protocols
