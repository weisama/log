...
# 创建我的配置配置
gedit /home/chen/ws_livox/src/realsense-ros/config/orb_slam3_config.yaml
#############################
camera_name: "camera"
...
```
# 启动双目，使用我的配置
ros2 launch realsense2_camera rs_launch.py config_file:=/home/chen/ws_livox/src/realsense-ros/config/orb_slam3_config.yaml
...
# 设置 ATTITUDE_QUATERNION 200Hz
master.mav.command_long_send(
    master.target_system,
    master.target_component,
    mavutil.mavlink.MAV_CMD_SET_MESSAGE_INTERVAL,
    0,
    33,      # ATTITUDE_QUATERNION
    0.005,
    0, 0, 0, 0, 0
)
